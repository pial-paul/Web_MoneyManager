...
$sql = "SELECT date, amount, note FROM transactions WHERE type = 'income' ORDER BY date DESC";
$result = $conn->query($sql);

// Initialize income records array
$incomeRecords = [];
    ...
    <div class="container">
        ...
        <div class="controls">
            <input
                ...
                onkeyup="filterTable('income-table', 'search-income')"
            />
            <button onclick="sortTable('income-table', 0)">Sort by Date</button>
        </div>
        <table id="income-table">
            ...
            <tbody>
                <?php
                // Display income rows dynamically
